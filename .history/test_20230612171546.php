...
<body onload="totalPrice()">
            <div class="checkbox" id="checkout" >
    ...
    ?>
        ...
        <div class="recap">
            ...
            <h1>Récapitulatif</h1>
            <br>
            <div><span class="total"> Sous-Total :</span> <span class="toutal"  name="totalprice"></span></div>
            <br>
            ...
            <hr>
            <div> <span class="total" id="totale"> Total : </span id="totoo"> </div>
            <hr>
        ...
        <div id="check">
            ...
            <div>Nom sur la carte</div>
            <input type="text" id ="nom">
            <div>Date d'expiration</div>
            <input type="text" id ="date">
            <div>Code de sécurité</div>
            <input type="text" id="cvc" placeholder="CVC">
            <input  type="submit" name="submit" value="Confirmer" onclick="verif()">
