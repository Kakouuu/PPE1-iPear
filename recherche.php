...
$sql = "select * from fruitslegumes where  Nom like'" . $recher . "%'";
...
while (($row = mysqli_fetch_array($result)) && $count < 4){
    ...
    $count += 1;
    ?>
<div style="border-bottom: 1px lightgray solid;  display: flex; position: relative; padding: 8px; height: 100px;">
